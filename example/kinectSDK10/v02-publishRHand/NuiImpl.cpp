...
static const COLORREF g_JointColorTable[NUI_SKELETON_POSITION_COUNT] = 
{
    ...
    RGB(255,  255,  255),  // NUI_SKELETON_POSITION_ELBOW_LEFT
    RGB(0, 0, 0),   // NUI_SKELETON_POSITION_WRIST_LEFT
...
void CSkeletalViewerApp::Nui_GotSkeletonAlert( )
{
    ...
    {
		if ( SkeletonFrame.SkeletonData[i].eTrackingState == NUI_SKELETON_TRACKED &&
            SkeletonFrame.SkeletonData[i].eSkeletonPositionTrackingState[NUI_SKELETON_POSITION_WRIST_RIGHT] != NUI_SKELETON_POSITION_NOT_TRACKED &&
